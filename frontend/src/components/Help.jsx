...
const SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      ['Which monthly rate',
        ['Switchable, on the page, because calculators disagree by enough to matter. “Compounded” — the default — means twelve months compound to exactly the annual figure you typed. It is what Excel’s NOMINAL() gives and what planning workbooks use.',
          '“Annual ÷ 12” is what most online calculators use. It is there so a cross-check against one of them is like for like, but it overstates the same assumption — by about a seventh at 15% over twenty years — so it is not the default.']],
